      ...
      <Container
        ...
        <View style={{ paddingHorizontal: 20 }}>
          ...
          <RCViewFlex style={{ flexDirection: "column" }}>
            ...
            <Text>{!this.state.event ? "" : String(this.state.event.description).substring(0,this.state.subString)}</Text>
            <TouchableOpacity
            onPress={()=>{
              ...
              <Text style={{paddingHorizontal:5}}>{this.state.subString === undefined ? 'Zwiń': 'Rozwiń'}</Text>
            </TouchableOpacity>
          </RCViewFlex>
        </View>
        <View style={{ paddingHorizontal: 20, paddingVertical: 10 }}>
          <Text style={{ fontSize: 20, fontWeight: "bold", paddingBottom: 5 }}>{"Harmonogram"}</Text>
        </View>
        <FlatList
          horizontal
