...
import ModalMultiList from "../../../components/ModalMultiList";
import ModalPickerPawn from "../../../components/ModalPickerPawn";
import ModalSingleList from "../../../components/ModalSingleList";
...
class AddItem extends Component<SceneProps, State> {
                        ...
                        <WithScannerText
                            ...
                            onPress={() => {
                                if (Store.propsStore.game.id === 0) {
                                    Store.propsStore.setScanQRItem(3);
    ...
    publisherAdd() {
        ...
        networkService.addPublisher(name)
            .then(response => {
    ...
    boardGameEdit = () => {
        ...
        networkService.updateBoardGame(
            name,
            uuid,
            description,
            minPlayers,
